...
<div class="alert alert-danger d-flex align-items-center" role="alert" id="alert-preencher">
...
#alert-preencher {
  ...
  right: 30px; /* define a distância do lado direito */
  width: 400px;
}
